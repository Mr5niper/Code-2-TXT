...
A lightweight, GUI-only Windows app (built from a single Python file). No command line,
no arguments, no setup. Just run it and click through two dialogs.

<img width="482" height="397" alt="image" src="https://github.com/user-attachments/assets/7d842b55-d347-4bcf-950d-96dadab47923" />

---

## Quick start

1. Get **`Code-2-TXT.exe`**. Download it from the
   [Releases page](https://github.com/Mr5niper/Code-2-TXT/releases), or build it yourself
   (see [Building the .exe](#building-the-exe-windows)).
2. Double-click it. The options window opens.
3. Pick a mode, leave the defaults or tweak them, and press **OK**.
...
splitting on). No installation, no Python, no command line.
...
Point it at a **single script** (`.py`, `.ps1`, `.atsb`, `.vb`, `.bat`, and so on). It puts that
